...
export interface QCElectronicsPermitApplicationProps {
  onCancel: () => void;
  onSubmit: (data: {
    scopeOfWork: string;
...
export const QCElectronicsPermitApplication: React.FC<QCElectronicsPermitApplicationProps> = ({
  onCancel,
  onSubmit,
  showToast
}) => {
  // Panel 1: Scope & Applicant Details
  const [scopeOfWork, setScopeOfWork] = useState<string>('New Installation');
  ...
  const [applicantAddress, setApplicantAddress] = useState<string>('Quezon Avenue cor. BIR Road, Diliman, Quezon City');
  ...
  const [street, setStreet] = useState<string>('Quezon Avenue cor. BIR Road');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (showToast) {
      showToast('Electronics Permit application submitted successfully!');
    }
  };
      ...
      <div className="rounded-xl overflow-hidden border border-slate-300 dark:border-slate-700 bg-white dark:bg-[#0c1629] shadow-xs">
        ...
        <div className="p-4 sm:p-5">
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* ============================================================== */}
            {/* PANEL 1: SCOPE OF WORK, OWNERSHIP & APPLICANT DETAILS */}
            {/* ============================================================== */}
