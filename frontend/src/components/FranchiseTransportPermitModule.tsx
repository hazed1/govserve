  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col font-sans transition-colors duration-200">
      ...
      <section className="w-full bg-gradient-to-r from-[#071326] via-[#0E2744] to-[#0A1A2F] text-white py-7 sm:py-9 px-4 sm:px-8 border-b border-slate-800 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-9">
        ...
        {/* ========================================================================= */}
        {/* SUBVIEW 1: NEW FRANCHISE WIZARD */}
        {currentView === 'new_franchise_wizard' && (
          <div className="space-y-4 max-w-4xl mx-auto animate-in fade-in pb-8">
              ...
              <div className="flex items-center space-x-3 pb-4 border-b border-slate-100 dark:border-slate-800">
                ...
                <div>
                  <h2 className="text-xl font-black text-slate-900 dark:text-white">
                    New MTOP Franchise Application Wizard
                  </h2>
                  <p className="text-xs text-slate-500">Step {wizardStep} of 3 • Municipal Transport Regulatory Board</p>
                </div>
              </div>

              {!newFranchiseSubmitted ? (
                <div className="space-y-6 text-xs">
                  {wizardStep === 1 && (
                    <div className="space-y-4">
                      <h4 className="font-bold text-slate-900 dark:text-white text-sm uppercase tracking-wider text-[11px]">
                        1. Operator Personal Details
                      </h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Operator Full Name *</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Mobile Contact Number *</label>
                          <input
                            type="text"
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full mt-1 p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-semibold text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-emerald-500 focus:outline-none cursor-pointer"
                          >
                            ...
                            <option value="UMID Card">UMID Card (SSS / GSIS)</option>
                            <option value="Philippine Passport">Philippine Passport (DFA)</option>
                            <option value="Voter's Certificate / ID">Voter's Certificate / ID (COMELEC)</option>
                            <option value="Postal ID">Postal ID (PhilPost)</option>
                          </select>
                        </div>
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Government ID Number *</label>
                          <input
                            type="text"
                            value={governmentIdNo}
                            onChange={(e) => setGovernmentIdNo(e.target.value)}
                            placeholder="e.g. N01-08-123456"
                            className="w-full mt-1 p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-mono text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex justify-end pt-4 border-t border-slate-100 dark:border-slate-800">
                        <button
                          ...
                          className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold flex items-center space-x-2"
                        >
                          <span>Proceed to Vehicle Specs</span>
                          <ArrowRight size={14} />
                        </button>
                      </div>
                    </div>
                  ...
                  {wizardStep === 2 && (
                    <div className="space-y-4">
                      <h4 className="font-bold text-slate-900 dark:text-white text-sm uppercase tracking-wider text-[11px]">
                        2. Vehicle & TODA Route Information
                      </h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Affiliation *</label>
                          <select
                            value={todaOrg}
                            onChange={(e) => setTodaOrg(e.target.value)}
                            className="w-full mt-1 p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-semibold text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                          >
                            ...
                            <option value="Project 6 & Veterans TODA (PVTODA)">Project 6 & Veterans TODA (PVTODA)</option>
                            <option value="Bagong Silangan TODA (BASTODA)">Bagong Silangan TODA (BASTODA)</option>
                            <option value="Kamuning-Kamias TODA (KK-TODA)">Kamuning-Kamias TODA (KK-TODA)</option>
                            <option value="Loyola Heights TODA (LHTODA)">Loyola Heights TODA (LHTODA)</option>
                            <option value="Payatas Heights TODA (PAHTODA)">Payatas Heights TODA (PAHTODA)</option>
                            <option value="Quezon City Transport Service Cooperative (QCTSC)">Quezon City Transport Service Cooperative (QCTSC)</option>
                            <option value="QC Central Drivers & Operators Association (QCDOA)">QC Central Drivers & Operators Association (QCDOA)</option>
                            <option value="Independent / QC Non-Affiliated Operator">Independent / QC Non-Affiliated Operator</option>
                          </select>
                        </div>
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Vehicle Classification *</label>
                          <select
                            value={vehicles[0]?.unitType || 'Tricycle (MTOP)'}
                            onChange={(e) => {
                              const updated = [...vehicles];
                              if (updated[0]) updated[0].unitType = e.target.value as any;
                              setVehicles(updated);
                            }}
                            className="w-full mt-1 p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs"
                          >
                        ...
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Make / Brand *</label>
                          <input
                            type="text"
                            value={vehicles[0]?.makeBrand || ''}
                            onChange={(e) => {
                              const updated = [...vehicles];
                              if (updated[0]) updated[0].makeBrand = e.target.value;
                              setVehicles(updated);
                            }}
                            className="w-full mt-1 p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs"
                          />
                        ...
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Plate Number *</label>
                          <input
                            type="text"
                            value={vehicles[0]?.plateNumber || ''}
                            onChange={(e) => {
                              const updated = [...vehicles];
                              if (updated[0]) updated[0].plateNumber = e.target.value;
                              setVehicles(updated);
                            }}
                        ...
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Engine / Motor Number *</label>
                          <input
                            type="text"
                            value={vehicles[0]?.motorNumber || ''}
                            onChange={(e) => {
                              const updated = [...vehicles];
                              if (updated[0]) updated[0].motorNumber = e.target.value;
                              setVehicles(updated);
                            }}
                            className="w-full mt-1 p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-mono"
                          />
                        ...
                        <div>
                          <label className="font-bold text-slate-700 dark:text-slate-300">Chassis Serial Number *</label>
                          <input
                            type="text"
                            value={vehicles[0]?.chassisNumber || ''}
                            onChange={(e) => {
                              const updated = [...vehicles];
                              if (updated[0]) updated[0].chassisNumber = e.target.value;
                              setVehicles(updated);
                            }}
                            className="w-full mt-1 p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-mono"
                          />
                      ...
                      <div className="flex justify-between pt-4 border-t border-slate-100 dark:border-slate-800">
                        <button onClick={() => setWizardStep(1)} className="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-xl font-bold">
                          Back
                        </button>
                        <button onClick={() => setWizardStep(3)} className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold flex items-center space-x-2">
                  ...
                  {wizardStep === 3 && (
                    <div className="space-y-4">
                      <h4 className="font-bold text-slate-900 dark:text-white text-sm uppercase tracking-wider text-[11px]">
                        3. Review & Legal Declaration
                      </h4>

                      <div className="p-4 sm:p-5 bg-emerald-50/70 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 rounded-2xl space-y-3 text-xs">
                        <p className="font-bold text-emerald-900 dark:text-emerald-200 text-sm">Application Summary:</p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-slate-700 dark:text-slate-300">
                          <p><strong>Operator:</strong> {applicantFullName}</p>
                          <p><strong>Affiliation:</strong> {todaOrg}</p>
                          <p><strong>Vehicle Unit:</strong> {vehicles[0]?.makeBrand} ({vehicles[0]?.plateNumber || 'Pending'})</p>
                          <p><strong>Route:</strong> {startingPoint} ↔ {destination}</p>
                        </div>
                        ...
                        <div className="pt-2 border-t border-emerald-200/80 dark:border-emerald-800/80 space-y-2">
                          ...
                          <div className="bg-white/90 dark:bg-slate-900/90 rounded-xl p-3 border border-emerald-100 dark:border-emerald-900/60 divide-y divide-slate-100 dark:divide-slate-800 text-[11px]">
                            <div className="flex justify-between py-1 text-slate-600 dark:text-slate-400">
                              <span>• Franchise Supervision Fee</span>
                              <span className="font-mono font-semibold text-slate-800 dark:text-slate-200">₱350.00</span>
                            </div>
                            <div className="flex justify-between py-1 text-slate-600 dark:text-slate-400">
                              <span>• Filing & Processing Fee</span>
                              <span className="font-mono font-semibold text-slate-800 dark:text-slate-200">₱200.00</span>
                            </div>
                            <div className="flex justify-between py-1 text-slate-600 dark:text-slate-400">
                              <span>• Annual Validation Sticker & QR Plate</span>
                              <span className="font-mono font-semibold text-slate-800 dark:text-slate-200">₱150.00</span>
                            </div>
                            <div className="flex justify-between py-1 text-slate-600 dark:text-slate-400">
                              <span>• Motor Vehicle Inspection Fee</span>
                              <span className="font-mono font-semibold text-slate-800 dark:text-slate-200">₱250.00</span>
                            </div>
                            <div className="flex justify-between py-1 text-slate-600 dark:text-slate-400">
                            ...
                            <div className="flex justify-between py-1 text-slate-600 dark:text-slate-400">
                              ...
                              <span className="font-mono font-semibold text-slate-800 dark:text-slate-200">₱100.00</span>
                            </div>
                            <div className="flex justify-between py-1 text-slate-600 dark:text-slate-400">
                              <span>• Legal Research Fund (LRF)</span>
                              <span className="font-mono font-semibold text-slate-800 dark:text-slate-200">₱50.00</span>
                            </div>
                            <div className="flex justify-between pt-1.5 font-bold text-xs text-emerald-700 dark:text-emerald-300">
                      ...
                      <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700">
                        <label className="flex items-start space-x-2.5 cursor-pointer">
                          ...
                          <span className="text-slate-600 dark:text-slate-300 leading-relaxed text-[11px]">
                            I hereby swear under oath that all information submitted is true, correct, and in full accordance with the City Transport and Traffic Management Code. I agree to subject my vehicle unit to mandatory physical roadworthiness and smoke emission inspection.
                          </span>
                        </label>
                      </div>

                      <div className="flex justify-between pt-4 border-t border-slate-100 dark:border-slate-800">
                        <button onClick={() => setWizardStep(2)} className="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-xl font-bold">
                          Back
                        </button>
                        <button
                          onClick={() => {
                            setNewFranchiseSubmitted(true);
                            if (onAddNewApplication) {
                              onAddNewApplication(applicantFullName, 'Franchise & Transport Permit');
                            }
                            showToast('Franchise application lodged successfully!');
                          }}
                          className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold shadow-lg shadow-emerald-600/30 flex items-center space-x-2"
                        >
                          <CheckCircle2 size={16} />
                          <span>Submit Official MTOP Application</span>
                        </button>
                      </div>
                    </div>
                  )}
                ...
                <div className="text-center py-8 space-y-4 animate-in zoom-in-95">
                  ...
                  <p className="text-xs text-slate-500 max-w-md mx-auto">
                    Your MTOP franchise application has been assigned tracking code <strong className="text-emerald-600 font-mono">MTOP-2025-0994</strong>. Please proceed to the inspection center on your scheduled date.
                  </p>
