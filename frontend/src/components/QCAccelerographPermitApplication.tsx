...
export interface QCAccelerographPermitApplicationProps {
  onCancel: () => void;
  onSubmit: (data: {
...
export const QCAccelerographPermitApplication: React.FC<QCAccelerographPermitApplicationProps> = ({
  onCancel,
  onSubmit,
  showToast
}) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (showToast) {
      showToast('Accelerograph Permit application submitted successfully!');
    }
  };
    ...
    <div className="w-full max-w-5xl mx-auto space-y-4">
      <div className="rounded-xl overflow-hidden border border-slate-300 dark:border-slate-700 bg-white dark:bg-[#0c1629] shadow-xs">
        ...
        <div className="bg-[#0c4366] text-white px-4 py-2.5 text-xs font-bold uppercase tracking-wider">
          Accelerograph Permit Application
        </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                ...
                <div className="flex items-center space-x-6 text-xs text-slate-700 dark:text-slate-300">
                  <label className="inline-flex items-center space-x-2 cursor-pointer">
                    <input
                      type="radio"
                      name="accelerograph_isLandOwner"
                      value="Yes"
